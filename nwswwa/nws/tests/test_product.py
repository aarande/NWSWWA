...
class TestProduct(unittest.TestCase):
    ...
    def test_svs_search(self):
        ...
        self.assertEqual(tp.segments[0].svs_search(),
                         "* AT 1150 AM CDT...THE NATIONAL WEATHER SERVICE HAS ISSUED A TORNADO WARNING FOR DESTRUCTIVE WINDS OVER 110 MPH IN THE EYE WALL AND INNER RAIN BANDS OF HURRICANE KATRINA. THESE WINDS WILL OVERSPREAD MARION...FORREST AND LAMAR COUNTIES DURING THE WARNING PERIOD.")
    ...
    def test_bullets(self):
        ...
        self.assertEqual(tp.segments[0].bullets[3],
                         "LOCATIONS IMPACTED INCLUDE... MARYSVILLE...LOVILIA...HAMILTON AND BUSSEY.")

        tp = product.TextProduct(
            get_file('FLSDMX.txt'))
        self.assertEqual(len(tp.segments[2].bullets), 7)
        self.assertEqual(tp.segments[2].bullets[6],
                         "IMPACT...AT 35.5 FEET...WATER AFFECTS 285TH AVENUE NEAR SEDAN BOTTOMS...OR JUST EAST OF THE INTERSECTION OF 285TH AVENUE AND 570TH STREET.")
