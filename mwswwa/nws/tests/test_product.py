...
from mwswwa.nws import product, ugc
from mwswwa.nws.product import WMO_RE
from mwswwa.nws.product import TextProductException
from mwswwa.nws.products import parser as productparser
